...
<div id="license-settings-area">
	...
	<div id="license-area-right">
		...
		<div id="too-many-license" class="license-status">
			<?php _e( 'Too many cooks in the kitchen!', 'wptouch-pro' ); ?>
			<p><?php _e( 'The bravenewcode.com server says you’ve used all your activations. What do you want to do?', 'wptouch-pro' ); ?></p>
			<a href="http://www.bravenewcode.com/support/" class="button"><?php _e( 'Upgrade My License', 'wptouch-pro' ); ?></a>
			<a href="http://www.bravenewcode.com/support/" class="button"><?php _e( 'Manage My Licenses', 'wptouch-pro' ); ?></a>
		</div>	
		...
		<div id="server-issue-license" class="license-status">
			...
			<p><?php echo sprintf( __( 'Please %scontact us%s and let us know about it.', 'wptouch-pro' ), '<a href="http://www.bravenewcode.com/contact-us/">', '</a>' ); ?></p>
		</div>
	</div>
</div>
